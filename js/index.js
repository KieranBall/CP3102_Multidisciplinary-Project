var description1 = "With a Budget of 250 million Townsville is Receiving a much-needed boost to its businesses overall Townsville economy. The Queensland government has Contributed $140 million to the project. The Australian Government had contributed 100 Million and the national rugby league and North Queensland cowboys have contributed 10 million. With 354 business affected directly by the construction of the stadium 342 are local meaning the money spent here will stay here. " + "<br><br>" + "NQ Reo is one of the business involved in construction. NQ Reo manufactured the Piles the stadium rests on and uses locally sourced materials in their construction with 44 business it sourced their materials and services from only 3 were not local.The money is being spend in Townsville and it is staying in Townsville.  ";
var description2 = "Since taking on the North Queensland stadium project KLN electrical services NQ REO, and GPB Constructions have all taken on new employees since working on the stadium project.   Project Manager, Kurt Poplin, hadn’t had a new apprentice on the books in eight years. " + "<br><br>" + "New plant operators’ electricians and apprentices have all found work thanks to the North Queensland Stadium. These are just four business and collectively they have created 10 jobs because of the Construction of the stadium for just four business.";
...
var description9 = "The Townsville economy is a diverse and complex system of individual people and business. Supporting our local construction industry helps not only them but because the industry needs uniforms, raw supplies and oncourse people the money the government spends for the stadium actually comes back to help everyone in some small way. " + "<br><br>" + "The stadium and its location and all of the decisions around it are to bring some to Townsville to foster and ongoing growth cycle that starts at the centre of the city at the stadium and will radiate out as people find jobs increase work capacity and finally financially the construction of the stadium is not just for football fans it’s for us all.";
    ...
    switch(card_id) {
        case "1":
            document.getElementById("modal_body").innerHTML = "<p>" + description1 + "</p>";
            break;
        case "2":
            document.getElementById("modal_body").innerHTML = "<p>" + description2 + "</p>";
            break;
        case "3":
            document.getElementById("modal_body").innerHTML = "<p>" + description3 + "</p>";
            break;
        case "4":
            document.getElementById("modal_body").innerHTML = "<p>" + description4 + "</p>";
            break;
        case "5":
            document.getElementById("modal_body").innerHTML = "<p>" + description5 + "</p>";
            break;
        case "6":
            document.getElementById("modal_body").innerHTML = "<p>" + description6 + "</p>";
            break;
        case "7":
            document.getElementById("modal_body").innerHTML = "<p>" + description7 + "</p>";
            break;
        case "8":
            document.getElementById("modal_body").innerHTML = "<p>" + description8 + "</p>";
            break;
        case "9":
            document.getElementById("modal_body").innerHTML = "<p>" + description9 + "</p>";
            break;
        default:
